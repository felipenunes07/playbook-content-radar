...
function CreateDialog({ templates, ideas, onClose, onCreate, onCreateFromIdea, busy }) {
  const approvedIdeas = useMemo(() => ideas.filter((idea) => idea.victorVote === 'like' || (FERNANDO_ATIVO && idea.fernandoVote === 'like')), [ideas]);
