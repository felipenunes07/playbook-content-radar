...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const row = {
      ...
      lead_magnet: getField(booking, 'lead-magnet') ?? getField(booking, 'lead_magnet'),
      booking_origin: getField(booking, 'booking-origin') ?? getField(booking, 'booking_origin'),
      lead_owner: getField(booking, 'lead-owner') ?? getField(booking, 'lead_owner'),
      cta_position: getField(booking, 'cta-position') ?? getField(booking, 'cta_position'),
      utm_source: getField(booking, 'utm_source'),
      utm_medium: getField(booking, 'utm_medium'),
      utm_campaign: getField(booking, 'utm_campaign'),
      utm_content: getField(booking, 'utm_content'),
      utm_term: getField(booking, 'utm_term'),
